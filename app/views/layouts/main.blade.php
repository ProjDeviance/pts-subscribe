...
<html lang="en">
  <head>
    ...
    <title>Online Procurement Tracking System</title>
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="/" class="logo"><b>Online Procurement Tracking System</b></a>
            <!--logo end-->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  <p class="centered"><a href="/">{{HTML::image('assets/img/ui-sam.png', 'logo', array('class'=>'img-circle', ))}}</a></p>
