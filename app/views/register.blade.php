    ...
    @endif
      ...
      <br><br>
        <div class="form-group @if ($errors->has('lastname')) has-error @endif">
         <label class="col-sm-4 col-sm-4 control-label">Lastname</label>
            <div class="col-sm-8">
      ...
      <div class="form-group @if ($errors->has('municipality')) has-error @endif">
         <label class="col-sm-4 col-sm-4 control-label">Municipality</label>
            <div class="col-sm-8">
                {{ Form::text('municipality', Session::get('address'), array('class' => 'form-control', 'placeholder' => 'Municipality/City','maxlength'=>'255')) }}
        ...
        <br><br><br>
         ...
         <label class="col-sm-4 col-sm-4 control-label">Contact Number</label>
            <div class="col-sm-8">
      ...
      <div class="form-group @if ($errors->has('username')) has-error @endif">
         <label class="col-sm-4 col-sm-4 control-label">Username</label>
            <div class="col-sm-8">
                {{ Form::text('username', Session::get('email'), array('class' => 'form-control', 'placeholder' => 'Username','maxlength'=>'255')) }}
      ...
      <br><br><br>
        ...
        <div class="form-group @if ($errors->has('subscription_type')) has-error @endif">
              <label class="col-sm-4 col-sm-4 control-label">Subscription Type</label>
            <div class="col-sm-8">
